    ...
    <>
      ...
      <div className="Home">
        ...
        <div className="S1">
          ...
          <div className="S3">
            ...
            <div className="S2">
              ...
              <FormControl sx={{ width: "30vw", fontFamily: "cursive" }}>
                ...
                >
                  <CategoryIcon sx={{ fontSize: "20px" }} /> Categories
                </InputLabel>
                <Select
              ...
              <FormControl sx={{ width: "30vw" }}>
                <InputLabel
                  ...
                  id="demo-simple-select-label"
                >
                  <BusinessCenterIcon sx={{ fontSize: "20px" }} /> All Classes
                </InputLabel>
                <Select
                  labelId="demo-simple-select-label"
                  id="demo-simple-select"
          ...
          {lod1 ? (
            <div style={{ padding: "3vw" }} className="T5">
              {h.map((e) =>
                e.class_type.includes(data.allclasses) ? (
                  <Ticket
                    key={e.id}
